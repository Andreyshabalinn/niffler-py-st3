...
class ProfilePage(BasePage):
    def __init__(self, page):
        ...
        self.category_max_length_error = page.locator(
            "span", has_text="Allowed category length is from 2 to 50 symbols"
        )
    ...
    def archive_category(self, category_name: str):
        category = self.page.locator(
            "div.MuiBox-root", has=self.page.locator("span", has_text=category_name)
        )
